        ...
        <div className="container my-5">
          ...
          <div className="col-md-6">
              <div className="row my-3" style={{ textAlign: 'left' }}>
                ...
                {paymentItems.map((product) => (
                  <div key={product.id} className="col-md-6 mb-3 d-flex flex-column flex-md-row" style={{"width": "320px"}} >
            ...
            <div className="col-md-6 mb-3" style={{ textAlign: 'left' }}>
                ...
                {isLoggedIn && !isAddressSelected && (
                  <>
                    {addresses && addresses.length > 0 && addresses.map((address) => (
                      <div key={address.address} onClick={() => setCheckedAddress(address)}>
                    ...
                    {!showAdressForm ? (
                      <button onClick={() => setShowAdressForm(true)}>Add new address</button>
                    ) : (
              ...
              <div>
                {isPaymentSelected && (
                  <button onClick={() => { setProcess(true); toast('please wait while payment is in process'); }}>Place Order</button>
                )}
              </div>
            </div>
